...
public final class ExtraConfig {
    ...
    public static final class KickingLlamaConfig {
        public boolean enabled = true;
        public boolean llamaKickUndeadWhenNear = true;
        public boolean llamaKickArthropodWhenNear = true;
        public boolean llamaKickIfAttacked = true;
        public Float llamaKickDamageHeartsEasy = 0.5f;
        public Float llamaKickDamageHeartsNormal = 1.0f;
        public Float llamaKickDamageHeartsHard = 1.5f;
        public Double llamaKickHorizontalVelocity = 0.28;
        public Double llamaKickVerticalVelocity = 1.2;
        public List<String> llamaExtraEntities = new ArrayList<>();
    }
    ...
    public static final class RabiesConfig {
        ...
        public int rabiesHydrophobiaStartTime = 60000;
    ...
    public static final class Model {
        ...
        public KickingLlamaConfig kickingLlama = new KickingLlamaConfig();
    ...
    public static synchronized void load() {
        if (FILE.exists()) {
            try (FileReader r = new FileReader(FILE)) {
                ...
                normalize(m); // <--- New features are added to memory here
                DATA = m;
