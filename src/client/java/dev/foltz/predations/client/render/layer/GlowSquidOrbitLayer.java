...
public class GlowSquidOrbitLayer<E extends GlowSquidEntity> extends FeatureRenderer<E, SquidEntityModel<E>> {
    public GlowSquidOrbitLayer(FeatureRendererContext<E, SquidEntityModel<E>> ctx) { super(ctx); }
    ...
    public void render(MatrixStack matrices, VertexConsumerProvider consumers, int light,
        ...
        int r = 0, g = 255, b = 255, a = 180; // cyan
